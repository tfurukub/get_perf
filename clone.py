...
class NtnxRestApi:
    ...
    def clone_vm(self, snapshot_vm_uuid, vm_name, user_data_yaml):
        ...
        vm_customization_config_dto = {"userdata": answer_file}
...
if __name__ == "__main__":
    try:
        ...
        base_vm_uuid = 'dabd0008-2ebd-4c45-94e2-c7c9755361fd'  # Please specify a UUID of base VM
        tgt_vm_name = 'br_centos{0:03d}'  # Please a specify template of VM name
        num_vms = 1  # Please specify number of VMs to be generated
